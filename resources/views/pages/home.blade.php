@extends('layouts.app')
{{-- div di gunakan untuk membungkus isi content --}}

@section('content')
    <div id="content" class="bg-secondary overflow-y-hidden overflow-x-hidden">
        @if ($lists->count() == 0)
            <div class="d-flex flex-column align-items-center">
                <p class="fw-bold text-center">Belum ada tugas yang ditambahkan</p>
                {{--p class di gunakan untuk membungkus paragrap, fw-bold di gunakan untuk untuk menebalkan, text-center untuk menampikan teks rata tengah --}}
                
                <button type="button" class="btn btn-sm d-flex align-items-center gap-2 btn-outline-black"
                    style="width: fit-content;">
                    <i class="bi bi-plus-square fs-3"></i> Tambah
                </button>
                {{-- button di gunakan untuk membuat tombol --}}
            </div>
        @endif
